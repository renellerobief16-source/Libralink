...
function StudentSearch({ onBookClick, onBorrowClick }) {
  ...
  const searchBookInOtherSchools = async (book) => {
    ...
    try {
      ...
      const response = await api.get(`/books/search-other-schools?${searchParams.toString()}`);
  ...
  const handleAddToBorrowingList = (book) => {
    ...
    setBorrowingList((prev) => {
      ...
      const newItem = {
        ...
        partner_school_id: book.school_id !== currentSchoolId ? currentSchoolId : null,
  ...
  return (
    ...
    <div className={`animate-slide-up box-border w-full min-w-0 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 pb-20 sm:pb-8 transition-[padding] duration-300 ${selectedBook ? "lg:pr-[368px]" : ""}`}>
      ...
      {showOtherSchoolsModal && (
        ...
        <section ref={otherSchoolsSectionRef} className="mb-4 sm:mb-6 w-full scroll-mt-[80px] rounded-2xl border border-[#DDE6EF] bg-white p-4 shadow-sm sm:p-5 sticky top-[64px] md:top-[76px] z-40">
      ...
      <div className="mb-4 sm:mb-6 sticky top-[64px] md:top-[76px] z-30 bg-[#F8FAFC] pb-2">
          ...
          {showSearchHistory && searchHistory.length > 0 && (
            ...
            <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-[#E2E8F0] rounded-xl shadow-lg z-50 max-h-64 overflow-y-auto">
              ...
              <div className="flex items-center justify-between p-3 border-b border-[#E2E8F0]">
                ...
                <span className="text-sm font-medium text-[#0F172A]">Recent Searches</span>
              ...
              {searchHistory.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <span className="text-sm text-[#0F172A] truncate">{item}</span>
          ...
          <div className="relative mt-2 pt-2 border-t border-[#EEF2F6]">
            ...
            <div className="flex items-center justify-between gap-3 mb-1.5 px-0.5">
              ...
              <div className="flex items-center gap-1.5 min-w-0">
                ...
                <p className="text-[10px] font-semibold uppercase tracking-wide text-[#64748B]">Browse by subject</p>

                <span className="flex items-center gap-0.5 text-[9px] font-medium normal-case tracking-normal text-[#94A3B8] sm:hidden" aria-hidden="true">
            ...
            <div className="relative min-w-0">
              ...
              <div ref={filterRailRef} className="flex min-w-0 max-w-full gap-1.5 overflow-x-auto scroll-smooth overscroll-x-contain touch-pan-x pb-0.5 scrollbar-hide snap-x snap-mandatory animate-filter-rail" role="tablist" aria-label="Swipe book subjects horizontally">
                  ...
                  >
                    ...
                    {(() => {
                      ...
                      return (
                        ...
                        <span className="flex shrink-0 items-center justify-center w-4 h-4 rounded-md border border-current/25" aria-hidden="true">
            ...
            <div className="mt-2 pt-2 border-t border-[#EEF2F6]">
              ...
              <div className="flex items-center justify-between gap-2 mb-1.5 px-0.5">
                ...
                <p className="text-[10px] font-semibold uppercase tracking-wide text-[#64748B]">Popular authors</p>

                <span className="text-[9px] text-[#94A3B8]">Tap to search</span>

                </div>

                <span className="flex items-center gap-0.5 text-[9px] font-medium text-[#94A3B8] sm:hidden" aria-hidden="true">
              ...
              <div className="flex gap-1.5 overflow-x-auto overscroll-x-contain touch-pan-x pb-0.5 px-0.5 scrollbar-hide snap-x snap-mandatory" role="list" aria-label="Popular authors">
                ...
                {popularAuthors.map((author) => (
                  ...
                  >
                    ...
                    <span className="flex items-center justify-center w-5 h-5 rounded-md border border-[#DDE6EF] text-[#64748B]" aria-hidden="true">
            ...
            <div className="h-full flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-4">
                ...
                <div className="mb-6">
                  ...
                  <h3 className="text-sm font-semibold text-[#64748B] mb-3">Quick Filters</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      {notificationFilter === "all" && <CheckCircle className="w-4 h-4 ml-auto" />}
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl border border-[#E2E8F0] shadow-lg p-3 sm:p-4 lg:p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-[#0F172A]">Partner Schools</h2>
              ...
              {schools
                ...
                .filter(
                  ...
                  (school) =>
                    ...
                    school.school_code?.toLowerCase().includes(schoolSearchQuery.toLowerCase()),
                  ...
                  >
                    ...
                    {selectedSchool?.school_id === school.school_id ? (
                      ...
                      <>
                        ...
                        <div className="flex items-start gap-3 mb-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-[#64748B] mt-1">{school.school_code}</p>
                                ...
                                onClick={(e) => {
                                  ...
                                  setBorrowingFormList([

                                    {
                                      ...
                                      owner_school_name: book.library || school.school_name,
                      ...
                      <div onClick={() => {
                        ...
                        console.log('[SCHOOL SELECT] Selected school:', school);

                        console.log('[SCHOOL SELECT] school.school_id:', school.school_id);
                        ...
                        <div className="mt-3 pt-3 border-t border-[#E2E8F0]">
                          ...
                          <p className="text-xs text-[#64748B]">

                            {
                              ...
                              filteredBooks.filter((book) => book.school_id === school.school_id)
          ...
          <>
            ...
            {!loading && filteredBooks.length === 0 && (
              ...
              <div className="text-center py-20 px-4">
                ...
                <h3 className="text-lg font-semibold text-[#0F172A] mb-2">No books found</h3>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl border border-[#E2E8F0] shadow-sm p-4 sm:p-6 mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-[#F7FAFC] rounded-xl border border-[#E2E8F0]">
                ...
                <p className="text-sm text-[#64748B] mb-2">{selectedSchool.address}</p>

                <p className="text-sm text-[#64748B]">

                  <span className="font-medium">School Code:</span> {selectedSchool.school_code}
              ...
              <div className="mb-6 p-5 bg-[#F7FAFC] rounded-xl border border-[#E2E8F0]">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[#64748B] mb-2">{bookForOtherSchoolSearch.author}</p>
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs px-2 py-1 bg-green-100 text-green-700 rounded-md font-medium">
                        ...
                        Available — {bookForOtherSchoolSearch.available_copies || 1}{" "}

                        {bookForOtherSchoolSearch.available_copies === 1 ? "copy" : "copies"}
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          ...
                          console.log('[FIND OTHER SCHOOLS] currentSchoolId:', currentSchoolId);

                          console.log('[FIND OTHER SCHOOLS] selectedSchool:', selectedSchool);

                          console.log('[FIND OTHER SCHOOLS] selectedSchool.school_id:', selectedSchool.school_id);

                          const item = {

                              book_id:

                                bookForOtherSchoolSearch.book_id || bookForOtherSchoolSearch.id,
                              ...
                              partner_school_id: selectedSchool.school_id !== currentSchoolId ? currentSchoolId : null,
                          ...
                          console.log('[FIND OTHER SCHOOLS] Setting borrowing form item:', item);
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-5">
                      ...
                      <div className="flex-1 min-w-0 flex flex-col">
                        ...
                        <p className="text-[#64748B] text-sm mb-3 line-clamp-1">{book.author}</p>
                        ...
                        <div className="space-y-2">
                          ...
                          {(() => {
                            ...
                            const requestStatus = interSchoolRequestStatuses[requestKey];
              ...
              {showBorrowingForm ? (
                ...
                <div className="h-full flex flex-col">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-[#0F172A]">Borrowing Request</h3>
                ...
                <>
                    ...
                    <div className="flex gap-3 min-w-0">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-[#64748B] mb-2">
                          ...
                          <span className="font-semibold text-[#0F172A]">Author:</span>{" "}
                        ...
                        <p className="text-sm text-[#64748B]">
                          ...
                          <span className="font-semibold text-[#0F172A]">ISBN:</span>{" "}
                  ...
                  <div className="border-t border-[#E2E8F0] pt-6">
                    ...
                    {selectedBook.status_details && (
                      ...
                      <div className="mb-4 p-3 bg-[#F7FAFC] rounded-lg border border-[#E2E8F0]">

                        <p className="text-sm text-[#64748B]">{selectedBook.status_details}</p>
                    ...
                    {selectedBook.available_copies !== undefined && selectedBook.total_copies > 0 && (
            ...
            <div className="p-6 border-b border-[#E2E8F0]">
              ...
              <div className="flex justify-between items-center">
                ...
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-[#0F172A] mb-1">Borrowing List</h2>

                  <p className="text-[#64748B] text-sm">

                    {borrowingList.length} {borrowingList.length === 1 ? "book" : "books"} selected
              ...
              <div className="p-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-green-900">
                        ...
                        Request ID: {submittedRequest?.request_id || "LL-2026-000001"}
                ...
                <div className="text-center text-sm text-gray-600 mb-6">
                  ...
                  <p>
                    ...
                    Your borrowing request has been submitted successfully. Please wait for the

                    librarian to review and approve your request.
            ...
            >
              ...
              <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div>
                    ...
                    <h2 className="text-2xl font-bold text-white mb-1">Request Approved!</h2>
              ...
              <div className="p-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6 mb-6">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-4 text-center">Your QR Code</h3>
                  ...
                  <div className="bg-white rounded-lg p-4 flex items-center justify-center">
                    ...
                    {submittedRequest.qr_token ? (
                      ...
                      <QRCodeDisplay
                        ...
                        requestId={submittedRequest.request_id || "LL-2026-000001"}
              ...
              {searchingOtherSchools ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-[#64748B] mb-6">
                    ...
                    This book is not currently available in any partner school library.
                    ...
                    >
                      ...
                      <div className="bg-white rounded-lg p-3 mb-4 border border-[#E2E8F0]">
                        ...
                        <div className="flex gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[10px] text-[#94A3B8]">ISBN: {schoolData.isbn}</p>
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-sm text-[#64748B]">
                          ...
                          {schoolData.available_copies === 1 ? "copy" : "copies"}
      ...
      {false && showBookDetailModal && selectedBook && (
        ...
        <div className="bg-white rounded-2xl p-6 border border-[#E2E8F0] shadow-sm mb-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <h2 className="text-xl font-semibold text-[#0F172A]">Book Details</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <h3 className="text-2xl font-bold text-[#0F172A]">{selectedBook.title}</h3>
              ...
              <div className="flex items-center gap-2 text-[#64748B]">
                ...
                <span className="text-sm">{selectedBook.author || "Unknown Author"}</span>
              ...
              {selectedBook.isbn && (
                ...
                <div className="text-sm text-[#94A3B8]">ISBN: {selectedBook.isbn}</div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                  ...
                  {selectedBook.real_time_status === 'available' ? 'Available' : 'Unavailable'}
                ...
                {selectedBook.location && (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#64748B]">{selectedBook.location}</p>
                ...
                {selectedBook.shelf && (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-[#0F172A]">Shelf</p>

                      <p className="text-sm text-[#64748B]">{selectedBook.shelf}</p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#F7FAFC] rounded-xl p-4 border border-[#E2E8F0]">
                ...
                <h4 className="text-lg font-semibold text-[#0F172A] mb-4">Location Map</h4>

                <div className="h-64 bg-white rounded-lg overflow-hidden">

                  {selectedBook.latitude && selectedBook.longitude ? (

                    <MinimalSchoolMap school={{ 
